...
<br>
<br>
<form class="form-horizontal" id="tambahOrder">
    <div class="row">
        <div class="col-md-5">
            <div class="box">
                <div class="box-body">
                    <table class="table no-border">
                        ...
                        <tr>
                            <td>No Meja</td>
                            <td>:</td>
                            <td><input type="text" class="form-control" name="no_meja" required><note>*) Harus di isi</note></td>
                        </tr>
                        <tr>
                            <td>Tanggal</td>
                            <td>:</td>
                            ...
                            <td>
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="number" onkeyup="diskonOrder(this.value, $('#ttl_pembayaran').val())" class="form-control text-center diskon_order" id='diskon_order' name="diskon_order" value="0"  placeholder="Diskon">
                            ...
                            <td>
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" onkeyup="duitTunai(this.value, $('#ttl_pembayaran').val(), $('#diskon_order').val())" class="form-control text-right uang tunai" id='tunai' name="tunai" placeholder="Diskon">
...
<script>
    $('#tambahOrder').validate({
        ...
        submitHandler: function (form) {
            var url_form = '<?= base_url(); ?>index.php/transaksi/Trans_order/insertOrder.html';
            $.ajax({
                type: 'POST',
                url: url_form,
                data: $(form).serialize(),
    ...
    function simpanTrans(kode_menu) {
        ...
        var posting = $.post('<?= base_url() ?>index.php/transaksi/Trans_order/insertMenuTempo', {
...
//            window.location.reload();
    ...
    function load_tbl_menu(kode_order) {
        $('#tblKeranjang').load('<?php echo base_url(); ?>index.php/transaksi/Trans_order/ajax_tblKeranjang/' + kode_order);
    }
